...
import { CopyrightIcon,  FacebookIcon,  GlobeIcon, PhoneCallIcon } from 'lucide-react'
  ...
  return (
    <div className='w-full p-10 bg-[#1B4965] flex'>
        <div className='w-1/2 flex flex-col gap-5'>
            <h1 className='text-7xl uppercase font-medium font-kameron text-white'>MediClinic-Ai</h1>
