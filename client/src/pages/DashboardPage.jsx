...
function DashboardPage() {
    ...
    try {
        ...
        if (userInfo) {
            patientId = JSON.parse(userInfo)._id;
        }
    } catch (err) {
    ...
    return (
        <div className="dashboard flex gap-6 w-full p-6 bg-gray-100">
            <div className='flex flex-col gap-4 w-full md:w-[50%] min-w-[320px]'>
            ...
            <div className="payment-section bg-white shadow-lg rounded-lg p-6 w-[43%]">
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 font-medium mb-2" htmlFor="upi-id">UPI ID</label>
                    <input
                        id="upi-id"
                        type="text"
                        value={upiId}
